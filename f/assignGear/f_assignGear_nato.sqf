...
_silencer2 = "rhsusf_acc_nt4_black";	// 6.5 suppressor

_scope1 = "rhsusf_acc_eotech_552";	// Holosight
_scope2 = "rhsusf_acc_compm4";			// MRCO Scope - 1x - 6x
...
_carbine = "rhs_weap_m4a1_carryhandle_grip2";
...
_baseUniform = ["rhs_uniform_FROG01_d","rhs_uniform_FROG01_d"];
_baseHelmet = ["rhsusf_ach_helmet_headset_ocp","rhsusf_ach_helmet_headset_ocp"];
_baseGlasses = [];

// Vests
_lightRig = ["rhsusf_iotv_ocp","rhsusf_iotv_ocp"];
_mediumRig = ["rhsusf_iotv_ocp_Teamleader","rhsusf_iotv_ocp_Squadleader"]; 	// default for all infantry classes
...
// LOADOUT: FIRE TEAM LEADER
	case "ftl":
	{
		_unit addmagazines [_glriflemag,9];
