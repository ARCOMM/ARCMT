...
// Markers seen by players in BLUFOR-FIA slots.
	...
	case "blu_g_f":
	{
		...
		["UnitFIA_CO_M", 0, "COM", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
		["UnitFIA_DC_M", 0, "DCM", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
		["UnitFIA_ASL_M", 0, "AM", "ColorRed"] spawn f_fnc_localSpecialistMarker;
		["UnitFIA_BSL_M", 0, "BM", "ColorBlue"] spawn f_fnc_localSpecialistMarker;
		["UnitFIA_CSL_M", 0, "CM", "ColorGreen"] spawn f_fnc_localSpecialistMarker;
...
// Markers seen by players in OPFOR-FIA slots.
	...
	case "opf_g_f":
	{
		...
		["UnitOFIA_CO_M", 0, "COM", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
		["UnitOFIA_DC_M", 0, "DCM", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
		["UnitOFIA_ASL_M", 0, "AM", "ColorRed"] spawn f_fnc_localSpecialistMarker;
		["UnitOFIA_BSL_M", 0, "BM", "ColorBlue"] spawn f_fnc_localSpecialistMarker;
		["UnitOFIA_CSL_M", 0, "CM", "ColorGreen"] spawn f_fnc_localSpecialistMarker;
...
// Markers seen by players in INDEPENDENT-FIA slots.
	...
	case "ind_g_f":
	{
		...
		["UnitIFIA_CO_M", 0, "COM", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
		["UnitIFIA_DC_M", 0, "DCM", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
		["UnitIFIA_ASL_M", 0, "AM", "ColorRed"] spawn f_fnc_localSpecialistMarker;
		["UnitIFIA_BSL_M", 0, "BM", "ColorBlue"] spawn f_fnc_localSpecialistMarker;
		["UnitIFIA_CSL_M", 0, "CM", "ColorGreen"] spawn f_fnc_localSpecialistMarker;
