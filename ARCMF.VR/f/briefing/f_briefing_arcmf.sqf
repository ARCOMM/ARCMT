...
if (serverCommandAvailable "#kick" || isServer) then {
    _gear = "<br/><font size='18'>Assign Gear to Player</font><br/><font size='16'><execute expression=""openMap false; createDialog 'GUI_Gear';"">Open Gear Manager</execute></font>";
