...
for t in ["abel","Altis","Bootcamp_ACR","Bozcaada","cain","Chernarus","Chernarus_Summer","Desert_E","Desert_Island","eden","FDF_Isle1_a","mbg_celle2","noe","Porto","ProvingGrounds_PMC","Sara","Shapur_BAF","Stratis","Takistan","Tanoa","Thirsk","ThirskW","utes","VR","WL_WRoute191","Woodland_ACR","Zargabad","Caribou","fata","Malden","ruha","MCN_Aliabad","Tembelan","Ruha"]:
	try:
