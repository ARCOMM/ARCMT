...
for t in ["VR","utes","Sara","fallujah","Chernarus","Chernarus_Summer","Takistan","Zargabad","Desert_E","ProvingGrounds_PMC","Shapur_BAF","mbg_celle2","Stratis","bozcaada","Kunduz","Altis","vt5","mske","torabora","FDF_Isle1_a","Woodland_ACR","Bootcamp_ACR","kerama","eden","abel","cain","noe","Desert_Island"]:
	try:
